...
def benchmark_clustering(n_clusters, dimensions, n_samples_list, n_runs=5):
        ...
        for n_clust in n_clusters:
            for dim in dimensions:
                for n_samples in n_samples_list:
                    ...
                    print(f"Speedup   : {time_orig_mean/time_opt_mean:.2f}x")
                    print(f"Ratio mém.: {memory_orig_mean/memory_opt_mean:.2f}x")
